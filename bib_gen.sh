# Web
bib2bib --expand --no-comment --remove funding --remove award_ja -ob ./web/skoyamalab_en.bib str_def_full.bib data_en.bib
bib2bib -c 'not ($key : "_en$")' --expand --no-comment --remove funding --remove award_en -ob ./web/skoyamalab_ja.bib str_def_full.bib data_en.bib data_ja.bib
